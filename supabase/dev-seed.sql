...
INSERT INTO public.questions (id, created_by, type, content, content_hash, difficulty) VALUES
  ...
  ('ffffffff-0000-4000-8000-000000000006', 'aaaaaaaa-0000-4000-8000-000000000001',
   ...
   'hash_mc_006', 'hard'),
  ('ffffffff-0000-4000-8000-000000000007', 'aaaaaaaa-0000-4000-8000-000000000001',
   'multiple_choice',
   ...
   'hash_mc_007', 'medium'),
  ('ffffffff-0000-4000-8000-000000000008', 'aaaaaaaa-0000-4000-8000-000000000001',
   'multiple_choice',
   ...
   'hash_mc_008', 'easy'),
  ('ffffffff-0000-4000-8000-000000000009', 'aaaaaaaa-0000-4000-8000-000000000001',
   'multiple_choice',
   'If a store offers a 25% discount on an item originally priced at $80, what is the sale price?',
   'hash_mc_009', 'easy'),
  ('ffffffff-0000-4000-8000-000000000010', 'aaaaaaaa-0000-4000-8000-000000000001',
   'multiple_choice',
...
INSERT INTO public.questions (id, created_by, type, content, content_hash, difficulty) VALUES
  ('ffffffff-0000-4000-8000-000000000011', 'aaaaaaaa-0000-4000-8000-000000000001',
   'short_answer',
   'If 2x - 5 = 11, what is the value of x?',
   'hash_sa_001', 'easy'),
  ('ffffffff-0000-4000-8000-000000000012', 'aaaaaaaa-0000-4000-8000-000000000001',
   'short_answer',
   'A rectangle has a length of 12 cm and a width of 7 cm. What is the perimeter in centimeters?',
   'hash_sa_002', 'easy'),
  ('ffffffff-0000-4000-8000-000000000013', 'aaaaaaaa-0000-4000-8000-000000000001',
   'short_answer',
   'What is 15% of 240?',
   'hash_sa_003', 'medium')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.question_options (question_id, label, content, is_correct, "order") VALUES
  -- Q1
  ('ffffffff-0000-4000-8000-000000000001', 'A', 'consistent', true, 1),
  ('ffffffff-0000-4000-8000-000000000001', 'B', 'contradictory', false, 2),
  ('ffffffff-0000-4000-8000-000000000001', 'C', 'irrelevant', false, 3),
  ('ffffffff-0000-4000-8000-000000000001', 'D', 'preliminary', false, 4),
  -- Q2
