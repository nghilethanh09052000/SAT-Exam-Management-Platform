...
export default async function ExercisesPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <p className="text-sm font-black uppercase tracking-[0.22em] text-[#6d7cff]">Luyện đề</p>
        ...
        <p className="mt-2 text-base font-medium text-[#778095]">
          Luyện đề mọi lúc, miễn phí, không cần lớp học. Duy trì streak để tiến bộ mỗi ngày.
        </p>
      </div>
      ...
      {exercises.length === 0 ? (
        <EmptyState
          ...
          description="Giáo viên đang chuẩn bị các bài tập luyện tập. Quay lại sau nhé!"
          icon={
